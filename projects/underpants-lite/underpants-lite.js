...
_.otherReject = function(array,test){
    function antiTest(val, i, collection) {
        return !test(val, i, collection);
    }
    
    return _.filter(array, antiTest);
}
...
_.partition = function(array, test){
    var finalArray = []
    var filterArray = _.filter(array,test) 
    var rejectArray = _.reject(array,test)
     finalArray.push(filterArray)
     finalArray.push(rejectArray)
...
_.every = function(collection, func){
    ...
    var test = _.map(collection, func)
...
_.some = function(collection, func){
  ...
  var array = _.map(collection, func)
...
/* Check how _.map() arguments should look; function(...)*/
//////////////////////////////////////////////////////////////////////
