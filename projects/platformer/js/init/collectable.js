(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.kennedi, 200, 170, 170,1);
        collectable.create(type.grace,800,70,50,1);
        collectable.create(type.steve,450,100,160,0.9);        
        collectable.create(type.db,50,550,200,0);
